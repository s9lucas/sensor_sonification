...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 151.0, 230.0, 12.0, 58.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 151.0, 230.0, 14.0, 66.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.0, 95.0, 37.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 92.0, 311.0, 12.0, 58.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 28.0, 58.0, 14.0, 66.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 20.0, 95.0, 48.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 17.0, 20.0, 29.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 21.0, 86.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 0.0, 46.0, 20.0 ],
					"style" : "",
					"text" : "ADC In"
				}
...
,
					"patching_rect" : [ 20.0, 263.0, 62.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 222.0, 33.0, 20.0 ],
					"style" : "",
					"text" : "0",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 37.0, 200.0, 39.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 43.0, 35.939552, 14.0 ],
					"prototypename" : "Arial9",
					"rounded" : 16.0,
					"style" : "",
					"text" : "0 dB",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 85.0, 203.0, 19.0, 61.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 58.0, 21.0, 68.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 37.0, 242.0, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 126.0, 37.0, 20.0 ],
					"style" : "",
					"triscale" : 0.7
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 20.0, 136.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "adc~ 1"
				}
